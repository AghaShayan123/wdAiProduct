            ...
            <div className='flex justify-center items-center gap-[5px] p-[5px] h-[50px] w-[300px] sm:w-[500px] '>
                {navItems.map((item, index) => (
                    <button
                        ...
                        className={`w-[100px] sm:w-[120px] text-[12px] font-[300] sm:text-[14px] sm:font-[500px] flex justify-center items-center text-center rounded-md transition-colors duration-300 h-[40px]
